      ...
      <div class="container">
        <div class="md-layout">
          <div class="md-layout-item md-size-50 md-small-size-70 md-xsmall-size-100">
            <h1 class="title">Covid Injury Research International Inc.</h1>
            <h4>
              CIRII’s vision is to provide patients, caregivers and their medical professionals, an international patient-centric community-based platform for realtime Covid injury symptom tracking, analysis and care.
            </h4>
            <br />
            <md-button href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="md-forget-me-not md-lg" target="_blank"><i class="fas fa-play"></i> Watch video</md-button>
          </div>
        </div>
      </div>
    </parallax>
        ...
        <div class="container">
          <div class="md-layout">
            <div class="md-layout-item md-size-66 md-xsmall-size-100 mx-auto">
              <h2 class="text-center title">Reach out to us</h2>
              <h4 class="text-center description">
                We're happy to answer any questions you may have. We'll get back to you as soon as possible.
              </h4>
              <form class="contact-form">
                ...
                <div class="md-layout">
                  <div class="md-layout-item md-size-33 mx-auto text-center">
                    <md-button class="md-forget-me-not">Send Message</md-button>
                  </div>
                </div>
              </form>
            </div>
...
<script>
  export default {
    ...
    props: {
      header: {
        type: String,
        default: require("@/assets/img/stock.png"),
      },
      // teamImg1: {
      //   type: String,
